...
public class SpringAppContextTestConstructer {

	public static void main(String[] args) {

		ApplicationContext context = new ClassPathXmlApplicationContext("SampleSpring.xml");

		OrderService os = context.getBean("os5", OrderService.class);
		ProductVO result = os.createOrder(createProductVO());
		System.out.println(result);

		OrderService os2 = context.getBean("os6", OrderService.class);
		ProductVO result2 = os2.createOrder(createProductVO());
		System.out.println(result2);

		OrderService os1 = context.getBean("os7", OrderService.class);
